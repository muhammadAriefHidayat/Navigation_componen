...
import com.apps.navigation.databinding.FragmentKetigaBinding
...
class KetigaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val aName  = KetigaFragmentArgs.fromBundle(arguments as Bundle).name
        binding.tvKetiga.text = "namanya $aName"
    }
}